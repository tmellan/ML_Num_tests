...
methods={"LinearRegression","NearestNeighbors"};
...
scores=Join[labels,Table[{methods[[i]],Correlation[trainOutputVal,polarisedOutputVal2[[i]]],(Correlation[trainOutputVal,polarisedOutputVal2[[i]]]+1)/2//N,logloss[[i]],loglossAccuracy[[i]],loglossRS[[i]],loglossAccuracyRS[[i]]},{i,1,Length@methods}]//N]; 
