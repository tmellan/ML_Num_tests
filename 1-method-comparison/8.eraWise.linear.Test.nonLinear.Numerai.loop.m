...
(*(*Unecessary:*)
(*valTestPureData=Transpose[Transpose[numeraiDataValidation[[2;;-1]]][[4;;-1]]];*)
(*Dimensions[valTestPureData]*)
(**)*)
...
(*"Correlations";*)
(*(*Delete - doesnt do anything correlationTable[[bestCorrelations]];*)*)
(*bestCorrs=Transpose[correlationTable[[bestCorrelations]]][[1]];*)
(*(*TO delete - same as bestCorrelations - topfeatures=bestCorrs;*)*)
(**)
(**)
...
(*methods={"LinearRegression",{"LinearRegression","L1Regularization"->l1RegParameter},{"LinearRegression","L2Regularization"->l2RegParameter}};*)
(**)
(*(*Train Net*)*)
...
(**)
(**)
(*"Method, correlation, success %, logloss, logloss-accuracy, RSlogloss, RSlogloss-accuracy";*)
...
(*Export["/home/tamellan/Desktop/Numerai/3.linearfullSet.numeraiTest.dat",raw];*)
